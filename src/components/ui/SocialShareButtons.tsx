  ...
  const platforms = [
    {
      ...
      label: 'LinkedIn',
      url: `https://www.linkedin.com/sharing/share-offsite/?url=${encodedUrl}&summary=${encodeURIComponent(socialShareText.linkedin)}`,
      color: 'bg-[#0077B5]',
    ...
    <div class="flex flex-wrap gap-3 justify-center">
      {platforms.map((p) => (
        <a
          ...
          class={`${p.color} text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity inline-flex items-center gap-2`}
